...
describe("valid-data", () => {
    ...
    it("double-type-alias", assertSchema("nightlife/double-type-alias", "MyObject", "extended"));
    ...
    it("type-partial3", assertSchema("nightlife/type-partial3", "MyObject", "extended"));
    it("type-pick1", assertSchema("nightlife/type-pick1", "MyObject", "extended"));
    it("type-pick2", assertSchema("nightlife/type-pick2", "MyObject", "extended"));
